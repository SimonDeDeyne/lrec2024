...
filepath$instructions = '../data/Vivas2022/Vivas2022.instructions.feat.txt'
filepath$outputfile = paste0('../output/raw/Vivas2022.feat.gpt4.',release,'.rds')
